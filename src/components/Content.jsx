		...
		<>
			<main>
				<div className='About-me'>
					...
					<p>I am a Front End Developer based in Poland. I have a passion for the creative process of building visually appealing designs and interactive user interfaces. Constantly seeking opportunities to learn new concepts, technologies, and tools, I strive to create the best possible user experience. My focus lies in programming and design, aiming to craft aesthetic and intuitive solutions. I am dedicated to expanding my skill set to stay up-to-date with the latest industry trends. Collaboration and working on innovative team projects excite me. With a keen eye for detail and a commitment to excellence, I approach each task with enthusiasm and strive for perfection in every project I undertake. </p>
				</div>
